                ...
                <Grid container spacing={1}>
                  ...
                  <Grid>
                    <Typography variant='body1'>
                      Provides a comprehensive research paper summary covering the synopsis, research methods, results,
                      and limitations from any uploaded paper.
                    </Typography>
                  </Grid>
                </Grid>
              </a>
            ...
            <div className='feature-box'>
              <Grid container spacing={1}>
                <a href='#prompt'>
                  ...
                  <Grid>
                    <Typography variant='body1'>
                      Recommends users with most 3 related papers our database based on keywords and topics.
                    </Typography>
                  </Grid>
                </a>
              </Grid>
            ...
            <div className='feature-box'>
              <a href='#upload'>
                <Grid container spacing={1}>
                  ...
                  <Grid>
                    <Typography variant='body1'>
                      Enables users to save and share collection of related research papers
                    </Typography>
                  </Grid>
                </Grid>
              </a>
